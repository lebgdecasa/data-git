# Owner Profile — The Board's Intel File

> The board reads this at boot. Owner: edit freely — sharper intel = sharper advice.
> Items marked ❓ are gaps the board should actively ask about, then record here.

## Identity & Position

- **Base:** Morocco (cost-of-living arbitrage: MAD expenses, EUR/USD/CHF income potential)
- **Languages:** Arabic, French, English, Spanish — 4-market outreach reach
- **Background:** Industrial Engineering · Product Management · Growth Hacking · Digital Marketing · E-commerce
- **Interests:** AI, SaaS, automation, online business, consulting, agencies, digital products, scalable ventures

## Mission

- Build significant wealth → financial freedom → relocate to **Switzerland**
...
Vehicle leaning: productized AI-leveraged service sold to EU/US/Gulf businesses. Service first,
SaaS later (earn the right to build software by being paid to solve the problem manually).
